...
public class PrometeoCarController : NetworkBehaviour
{
    ...
    //PRIVATE VARIABLES
      ...
      */
      ...
      private bool _wInput;
      private bool _sInput;
      private bool _aInput;
      private bool _dInput;
      private bool _spaceInput;
      
      private void OnInputW(InputValue value)
      {
          _wInput = value.isPressed;
      }
      private void OnInputS(InputValue value)
      {
          _sInput = value.isPressed;
      }
      private void OnInputA(InputValue value)
      {
          _aInput = value.isPressed;
      }
      private void OnInputD(InputValue value)
      {
          _dInput = value.isPressed;
      }
      private void OnInputSpace(InputValue value)
      {
